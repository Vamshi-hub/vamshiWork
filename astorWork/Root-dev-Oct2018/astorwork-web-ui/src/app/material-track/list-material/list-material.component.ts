...
export class ListMaterialComponent extends CommonLoadingComponent {
  displayedColumns = ['markingNo', 'block', 'level', 'zone', 'materialType', 'mrfNo', 'expectedDeliveryDate', 'stageName', 'actions'];
  ...
  onViewBIMClicked(material: MaterialMaster) {
    sessionStorage.setItem('model_urn', material.modelUrn);
    sessionStorage.setItem('element_id', String(material.elementId));
