...
namespace astorWorkDAO
{
    public class astorWorkDbContext : DbContext
    {
        ...
        public UserMaster GetUserFromHttpContext(HttpContext httpContext)
        {
            if (httpContext != null)
            {
                ...
                if (userClaim != null)
                    return UserMaster.Include(um => um.Vendor).FirstOrDefault(um => um.ID.ToString() == userClaim.Value);
            }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MaterialMaster>()
                .HasIndex(mm => new { mm.MarkingNo, mm.Block, mm.Level, mm.Zone })
                .IsUnique();
