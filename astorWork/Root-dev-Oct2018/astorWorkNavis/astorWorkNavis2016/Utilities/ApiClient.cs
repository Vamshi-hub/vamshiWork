...
namespace astorWorkNavis2016.Utilities
{
    public class ApiClient
    {
        ...
        {
            string uri = string.Format("material-tracking/projects/{0}/bim-sync", projectId);
        ...
        {
            string uri = string.Format("material-tracking/projects/{0}/bim-sync/{1}/video", projectId, bimSyncSessionId);
