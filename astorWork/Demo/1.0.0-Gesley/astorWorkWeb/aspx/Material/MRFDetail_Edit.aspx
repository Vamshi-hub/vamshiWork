                        ...
                        <telerik:RadWizardStep ID="uxHeader" Title="New Request" StepType="Start" ValidationGroup="vgMRFMaster" runat="server" CausesValidation="true" SpriteCssClass="vgMRFMaster">
                            <fieldset class="fieldsettemplate" style="height: 550px">
                                <table style="width: 95%; margin-left: 20px;">
                                    ...
                                    <tr>
                                        <td>
                                            <telerik:RadComboBox ID="uxBlock" runat="server" SkinID="RadComboBoxSkin" DataValueField="Code" ValidationGroup="vgMRFMaster" EmptyMessage="Select Block" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="Location_SelectedIndexChanged"></telerik:RadComboBox>
                                        ...
                                        <td>
                                            <telerik:RadComboBox ID="uxLevel" runat="server" SkinID="RadComboBoxSkin" DataValueField="Code" ValidationGroup="vgMRFMaster" EmptyMessage="Select Level" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="Location_SelectedIndexChanged"></telerik:RadComboBox>
                                        ...
                                        <td >
                                            <telerik:RadComboBox ID="uxZone" runat="server" SkinID="RadComboBoxSkin" DataValueField="Code" ValidationGroup="vgMRFMaster" EmptyMessage="Zone / Grid Line" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="Location_SelectedIndexChanged"></telerik:RadComboBox>
                                                    ...
                                                    <fieldset class="fieldsettemplate">
                                                        ...
                                                        <div class="layout">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <telerik:RadLabel ID="uxBlock" Text='<%# Bind("Block") %>' runat="server" Font-Size="Medium" SkinID="RadLabelSkinReadOnly"></telerik:RadLabel>
                                                                </td>
                                                                <td>
                                                                    <telerik:RadLabel ID="uxLevel" Text='<%# Bind("Level") %>' runat="server" Font-Size="Medium" SkinID="RadLabelSkinReadOnly"></telerik:RadLabel>
                                                                </td>
                                                                <td valign="top">
                                                                    <telerik:RadLabel ID="uxZone" Text='<%# Bind("Zone") %>' runat="server" Font-Size="Medium" SkinID="RadLabelSkinReadOnly"></telerik:RadLabel>
                                                                </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="4">
