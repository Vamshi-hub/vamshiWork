        ...
        <div class="col-md-12">
                                                        ...
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton OnClientClick="closeRadPanelBar();" OnClick="lbIncident_Click" Font-Size="14pt" CommandArgument="Incident" ID="lbIncident" runat="server"></asp:LinkButton>


                                                                </td>
                                                                <td>
                                                                    <asp:LinkButton OnClientClick="closeRadPanelBar();" ID="lbNearMiss" Font-Size="14pt" CommandArgument="Incident" OnClick="lbIncident_Click" runat="server"></asp:LinkButton>
                                                        ...
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <b>
                                                                        <asp:LinkButton ID="lbLastInspection" CommandArgument="Inspection" OnClick="lbIncident_Click"  OnClientClick="closeRadPanelBar();"
            ...
            <telerik:RadWindowManager ID="rwmRptVwr" runat="server" Behaviors="Close">
                ...
                <Windows>
                    ...
                    <telerik:RadWindow ID="rwDetails" runat="server" Title="Incident Details"  Width="620px" Behaviors="Maximize,Close">

                        <ContentTemplate>

                            <asp:HiddenField ID="hdnVideo" runat="server" />

                            <telerik:RadGrid Width="600px" RenderMode="Lightweight" ID="rdGrid" runat="server" AutoGenerateColumns="false"
                                >
                                <MasterTableView TableLayout="Fixed" AllowFilteringByColumn="false">
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="Remarks" UniqueName="col1" HeaderText="Remarks"
                                            HeaderStyle-Width="40%">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="IncidentDate" UniqueName="col2" HeaderText="Date of Incident"
                                            HeaderStyle-Width="20%">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="IncidentType" UniqueName="col3" HeaderText="Date of Incident"
                                            HeaderStyle-Width="20%">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridTemplateColumn UniqueName="pdf" HeaderStyle-Width="10%" HeaderText="Report">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="video" HeaderStyle-Width="10%" HeaderText="Video">
                                            <ItemTemplate>
