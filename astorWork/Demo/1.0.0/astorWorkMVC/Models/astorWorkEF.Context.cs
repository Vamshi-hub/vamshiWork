...
namespace astorWorkMVC.Models
{
    ...
    public partial class astorWorkEntities : DbContext
    {
        ...
        public virtual DbSet<BeaconAppUser> BeaconAppUsers { get; set; }
        ...
        public virtual DbSet<MaterialMasterMarkingNo> MaterialMasterMarkingNoes { get; set; }
        public virtual DbSet<BeaconGateWayData> BeaconGateWayDatas { get; set; }
    }
}
