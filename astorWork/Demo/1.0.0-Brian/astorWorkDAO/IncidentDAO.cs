...
namespace astorWorkDAO
{
    ...
    public class IncidentDAO
    {
        ...
        public DataTable getIncidentDetails(string strProject, string strDivision, string strContractor, string strIncidentType)
        {
            DataTable dt ;
            List<LocationEntity> lstLocations = new List<LocationEntity>();
            ...
            SqlParameter[] prms = new SqlParameter[]
            {
                ...
                ,new SqlParameter("@IsNearMiss",strIncidentType)
            };
