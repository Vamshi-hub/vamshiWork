                ...
                <telerik:RadGrid ID="rgMaterial" Width="100%" runat="server" PagerStyle-Mode="Advanced"
                    ...
                    <MasterTableView Width="100%" AllowSorting="true" AllowFilteringByColumn="false">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="MRFNo" HeaderText="MRF No." HeaderStyle-Width="9%"
                                ItemStyle-Width="9%" FilterControlWidth="40" />
                            <telerik:GridBoundColumn DataField="Block" HeaderText="Block" HeaderStyle-Width="9%"
                                ItemStyle-Width="9%" FilterControlWidth="40" />
                            <telerik:GridBoundColumn DataField="Level" HeaderText="Level" HeaderStyle-Width="9%"
                                ItemStyle-Width="9%" FilterControlWidth="40" />
                            <telerik:GridBoundColumn DataField="Zone" HeaderText="Zone" HeaderStyle-Width="9%"
                                ItemStyle-Width="9%" FilterControlWidth="40" />
