            ...
            ModuleMaster[] modulemaster = new ModuleMaster[] {
                new ModuleMaster
                {
                    ...
                    Pages = new List<PageMaster>
                    {
                        ...
                        new PageMaster{Name="ConsultantDashboard",UrlPath="dashboard-consultant"},
                        new PageMaster{Name="Maincon Dashboard",UrlPath="dashboard-maincon"},
                        new PageMaster{Name="import file",UrlPath="import-file"}
                    }
                },
                new ModuleMaster
                {
