...
namespace astorWorkDAO.Migrations
{
    ...
    [Migration("20191205062008_InspectionSignatureAssociationTableColumnModified")]
    partial class InspectionSignatureAssociationTableColumnModified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("astorWorkDAO.ChecklistAudit", b =>
                {
                    ...
                    b.Property<int?>("InspectionInfoID");
            ...
            modelBuilder.Entity("astorWorkDAO.ConfigurationMaster", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("Cofiguration");
            ...
            modelBuilder.Entity("astorWorkDAO.InspectionAudit", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("InspectionAudit");
                });

            modelBuilder.Entity("astorWorkDAO.InspectionSignatureAssociation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("InspectionAuditID");
                    ...
                    b.HasIndex("InspectionAuditID");

                    b.HasIndex("UserID");

                    b.ToTable("InspectionSignatureAssociation");
                });
            ...
            modelBuilder.Entity("astorWorkDAO.NotificationSeenBy", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("NotificationAuditID");

                    b.HasIndex("UserMasterID");

                    b.ToTable("NotificationSeenBy");
                });
            ...
            modelBuilder.Entity("astorWorkDAO.ChecklistAudit", b =>
                {
                    ...
                    b.HasOne("astorWorkDAO.InspectionAudit", "InspectionInfo")
                        .WithMany()
                        .HasForeignKey("InspectionInfoID");
            ...
            modelBuilder.Entity("astorWorkDAO.ConfigurationMaster", b =>
                {
                    b.HasOne("astorWorkDAO.UserMaster", "LastUpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("astorWorkDAO.InspectionSignatureAssociation", b =>
                {
                    b.HasOne("astorWorkDAO.InspectionAudit", "InspectionAudit")
                        .WithMany("Signatures")
                        .HasForeignKey("InspectionAuditID");
            ...
            modelBuilder.Entity("astorWorkDAO.NotificationSeenBy", b =>
                {
                    b.HasOne("astorWorkDAO.NotificationAudit", "NotificationAudit")
                        .WithMany("NotificationSeenBy")
                        .HasForeignKey("NotificationAuditID")
                        .OnDelete(DeleteBehavior.Cascade);
