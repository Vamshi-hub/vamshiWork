...
using astorWorkMaterialTracking.Controllers;
...
namespace astorWorkBackEndUnitTest.Controllers
{
    public class MaterialMastersControllerUnitTest : CommonFunctions
    {
        ...
        public async Task TestGetMaterialMaster_ImportFromTemplate()
        {
            ...
            int organisationID = responseJSONArray.First.Value<int>("id");
            ...
            using (var formDataContent = new MultipartFormDataContent()) {
                ...
                formDataContent.Add(new StringContent(organisationID.ToString(), Encoding.UTF8), "VendorId");
