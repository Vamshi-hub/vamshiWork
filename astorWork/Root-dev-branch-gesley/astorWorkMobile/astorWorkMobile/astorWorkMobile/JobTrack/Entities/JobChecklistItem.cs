...
namespace astorWorkMobile.JobTrack.Entities
{
    public class JobChecklistItem : MasterVM
    {
        ...
        public string YesbgColor
        {
            get
            {
                string yesBgColor = null;
                yesBgColor = (StatusCode == (int)ChecklistItemStatus.Pass ? "#00b57c" : NonSelectedBacgroundcolor);
                if (yesBgColor == NonSelectedBacgroundcolor && NobgColor == NonSelectedBacgroundcolor && NAbgColor == NonSelectedBacgroundcolor)
                {
                    yesBgColor = "#00b57c";
