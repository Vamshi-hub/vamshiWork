            ...
            try
            {
                ...
                */
                ...
                foreach (var stage in stages.Where(s => s.Order > 0).OrderBy(s => s.Order))
                {
                    ...
                    {
                        var red = Convert.ToInt32(stage.Colour.Substring(1, 2), 16) / 255.0;
                        var green = Convert.ToInt32(stage.Colour.Substring(3, 2), 16) / 255.0;
                        var blue = Convert.ToInt32(stage.Colour.Substring(5, 2), 16) / 255.0;
                        /*
