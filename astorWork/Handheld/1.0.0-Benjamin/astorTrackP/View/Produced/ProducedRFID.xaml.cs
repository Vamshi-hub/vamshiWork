...
{
	public partial class ProducedRFID : ContentPage
	{

        ProducedRFIDViewModel _vm;
		public ProducedRFID()
		{
			InitializeComponent ();
			NavigationPage.SetTitleIcon (this, "produced.png");            
            _vm = new ProducedRFIDViewModel(this.Navigation);
            BindingContext = _vm;
		...
		protected override void OnAppearing()
		{
            ...
            MessagingCenter.Subscribe<ProducedRFIDViewModel>(this, "ScanRFID", (s) =>
            {
                Task.Run(() => Device.BeginInvokeOnMainThread(() => Scan()));
            });            
            base.OnAppearing();
            _vm.MaterialMasterMarkingNo = null;
            //Scan();
        }
        ...
        protected override void OnDisappearing()
        {
            ...
            MessagingCenter.Unsubscribe<ProducedRFIDViewModel>(this, "ScanRFID");            
            base.OnDisappearing();
        }
        ...
        async void ScanTag()
        {
            ...
            if (_vm.MaterialMasterMarkingNo != null)
            {
                Device.BeginInvokeOnMainThread(() =>
                Navigation.PushAsync(new EnrollPending(_vm.MaterialMasterMarkingNo)));
            }
