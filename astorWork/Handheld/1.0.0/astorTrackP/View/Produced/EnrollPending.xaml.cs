...
{
	public partial class EnrollPending : ContentPage
	{
        EnrollPendingViewModel _vm;
        public EnrollPending(MaterialMasterMarkingNo markingNo)
        {
            InitializeComponent();
            _vm = new EnrollPendingViewModel(this.Navigation, markingNo);            
            BindingContext = _vm;    
