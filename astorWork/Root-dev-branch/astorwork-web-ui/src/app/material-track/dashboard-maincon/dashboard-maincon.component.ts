...
@Component({
  selector: 'app-dashboard-maincon',
  templateUrl: './dashboard-maincon.component.html',
  styleUrls: ['./dashboard-maincon.component.css']
})
export class DashboardMainconComponent extends CommonLoadingComponent {
