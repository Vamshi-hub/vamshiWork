...
export class MaterialstagedashboardComponent extends CommonLoadingComponent {
  ...
  changedtile1QC() {
    if (this.ischecked1 == true) {
      this.tile1QCcount = this.materialstatges.filter(s => s.stageID == this.tile1stageid && s.qCStatus == "All_QC_passed").length;
  ...
  changedtile2QC() {
    if (this.ischecked2 == true) {
      this.tile2QCcount = this.materialstatges.filter(s => s.stageID == this.tile2stageid && s.qCStatus == "All_QC_passed").length;
  ...
  changedtile3QC() {
    if (this.ischecked3 == true) {
      this.tile3QCcount = this.materialstatges.filter(s => s.stageID == this.tile3stageid && s.qCStatus == "All_QC_passed").length;
