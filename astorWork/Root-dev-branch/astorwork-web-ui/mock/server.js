...
server.use(jsonServer.rewriter(
  {
    ...
    "/projects/:projectId/organisations/:organisationId/inventory": "/projects/:projectId/inventory?organisationId=:organisationId",
    "/projects/:projectId/organisations/:organisationId/inventory/pre_create?materialType=:materialType": "/projects/:projectId/inventory_pre_create?organisationId=:organisationId&materialType=:materialType",
    ...
    "/qc/case?projectId=:project_id": "/qcCase?projectId=:project_id",
...
server.post('/projects/:projectId/organisations/:organisationId/inventory', (req, res) => {
  res.jsonp({
    status: 0
  })
})

server.post('/organisations/:organisationId/afterInventory', (req, res) => {
  res.jsonp({
    status: 0
  })
})
...
var claims = {
  ...
  "role": {
    ...
    "pageAccessRights": [
      ...
      {
        "url": "/configuration/organisation-master",
        "right": 3
      },
      {
        "url": "/configuration/organisation-details/:id",
        "right": 3
      },
      {
