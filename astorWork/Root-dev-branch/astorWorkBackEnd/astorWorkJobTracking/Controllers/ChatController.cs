...
namespace astorWorkJobTracking.Controllers
{
    ...
    public class ChatController : Controller
    {
        ...
        public async Task<List<MessageData>> GetChatList([FromQuery] string tenant_name)
        {
            ...
            try
            {
                chats = _context.ChatData.Include(u => u.User)
                    ...
                    .ThenInclude(mm => mm.MaterialMaster)
                    ...
                    .Select(c => new MessageData()
                    {
                        ...
                        Message = c.Message,
                        MaterialID = c.MaterialStageAudit != null ? c.MaterialStageAudit.MaterialMasterID : 0,
                        MarkingNo = c.MaterialStageAudit != null ? c.MaterialStageAudit.MaterialMaster.MarkingNo : string.Empty,
                        ModuleName = c.MaterialStageAudit != null ? $"{c.MaterialStageAudit.MaterialMaster.Block}_{c.MaterialStageAudit.MaterialMaster.Level}_{c.MaterialStageAudit.MaterialMaster.Zone}"
        ...
        public async Task<int> SaveChat([FromQuery] string user_name, [FromBody] MessageData messageData)
        {
            ...
            try
            {
                ...
                if (messageData != null)
                {
                    ...
                    {
                        materialStageAudit = _context.MaterialStageAudit.Where(msa => msa.MaterialMasterID == messageData.MaterialID).OrderByDescending(msa => msa.CreatedDate).FirstOrDefault();
                    }
