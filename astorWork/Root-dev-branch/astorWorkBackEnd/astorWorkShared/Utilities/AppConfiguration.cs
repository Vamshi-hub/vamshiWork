...
namespace astorWorkShared.Utilities
{
    public class AppConfiguration
    {
        public static void InitEnvironmentVariables()
        {
            ...
            Environment.SetEnvironmentVariable("VIDEO_CONTAINER", "dev-video-repo");
            ...
            Environment.SetEnvironmentVariable("SIGNALR_END_POINT", "Endpoint=https://astorwork.service.signalr.net;AccessKey=G9U2b4Vsq1ilXZH3jQRcoeBX1X/Ma395SacX7QXzob4=;Version=1.0;");
        }
        ...
        public static string GetSignalREndPoint()
        {
            return Environment.GetEnvironmentVariable("SIGNALR_END_POINT");
        }
