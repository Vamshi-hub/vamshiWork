    ...
    public class CommonFunctions
    {
        ...
        public async Task GetResponseJSONData(string apiEndPt, bool isArray)
        {
            ...
            if (isArray)
                ...
                responseJSONObj = JObject.Parse(JObject.Parse(responseString)["data"].ToString());
        }
        ...
        public async Task PutJSONData(string apiEndPt, string strContent)
        {
            StringContent jSONContent = new StringContent(strContent, Encoding.UTF8, "application/json");
        ...
        public void AssertValueInField(JObject responseJSONObj, string expectedValue, string field = "")
        {
            string result;
            if (field.Length == 0)
