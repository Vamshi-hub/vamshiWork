        ...
        protected void lbIncident_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lEntity != null)
                {
                    if (lbSource.CommandArgument == "Incident")
                    {
                        ...
                        if (lEntity.Incident_Accumulated > 1)
                        {
                           // myurl = myurl + "Video/NVR1.mp4";
                             hdnVideo.Value = "https://astortimeqa.blob.core.windows.net/jtc/IncidentVideos/NVRC.mp4"; ;
                        }
                        else
                        {

                            // myurl = myurl + "Video/NVR2.mp4";
                            hdnVideo.Value = "https://astortimeqa.blob.core.windows.net/jtc/IncidentVideos/NVRNC.mp4";
                        }
                    }
                    else
                    {
                    ...
                    DataTable dt;
                    if (lbSource.CommandArgument == "Incident")
                        dt = objDAO.getIncidentDetails(lblProjectName.Text, lblDivision.Text, lblContractor.Text);
                    else
