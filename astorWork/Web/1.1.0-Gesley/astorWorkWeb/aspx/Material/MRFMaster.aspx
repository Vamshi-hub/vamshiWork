                    ...
                    <MasterTableView Width="100%" ClientDataKeyNames="MRFNo,Status" DataKeyNames="MRFNo,Status" CommandItemDisplay="Top" EditMode="EditForms">
                        ...
                        <CommandItemTemplate>
                            <div style="padding: 5px 5px;">
                                <asp:Button ID="uxCreateNewMRF" runat="server" class="rgAdd" OnClientClick="return NewMRFCreation()" CommandName="CreateNewMRF" 
                                    Text="Create New Request" ToolTip="Create New Request" Visible=<%#!IsVendor()%>></asp:Button>
                                <asp:LinkButton ID="uxInsertNewMRF" runat="server" OnClientClick="return NewMRFCreation()" CommandName="CreateNewMRF" Text="Add" Visible=<%#!IsVendor()%>>Create New Request</asp:LinkButton>
