                ...
                if (file.FileName != null)
                {
                    ...
                    if (LocationName != null)
                    {
                            ...
                            if (drow.Table.Columns.Count >= 10)
                            {
                                try
                                {
                                    ...
                                    if (drow[10].ToString() != "" && ddlDirection.SelectedValue == "1")
                                    {
                                        ...
                                        dtResult.Rows.Add(drow[1], drow[2], LocationName[3], Convert.ToDateTime(drow[9].ToString() + " " + conv.TimeOfDay.ToString()), 1);
                                    }

                                    if (drow[11].ToString() != "" && ddlDirection.SelectedValue == "2")
                                    {
                                        conv = DateTime.FromOADate(double.Parse(drow[11].ToString()));
                                        dtResult.Rows.Add(drow[1], drow[2], LocationName[3], Convert.ToDateTime(drow[9].ToString() + " " + conv.TimeOfDay.ToString()), 2);
                                    }
                        ...
                        if (dtResult.Rows.Count > 0)
                        {
                            ...
                            Master.DisplayNotificationMessage("Rawclocktime Imported Successfully");
                        }
                    }
