...
namespace astorWork
{
    public partial class MRFMaster : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // for Edit MRF Detail
            string pageIDEdit = "MRFDetail_Edit.aspx";
            var dataEdit = api.GetPageMasterByPageID(pageIDEdit);
            uxDisplayNameEdit.Value = dataEdit.First().PageDisplayName;
            //Request.ApplicationPath + 
            uxURLEdit.Value = dataEdit.First().PageURL.ToString();
        }
        ...
        protected void uxMRFMaster_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            //if (objCommon.objUserProfile.UserID.ToLower() == Constants.ADMIN_USER_NAME.ToLower())
            //{
                var result = api.GetMRFMasters();
                uxMRFMaster.DataSource = result.OrderByDescending(MRFm => MRFm.MRFNo).ToList();
            //}
        }

        protected void uxMRFMaster_ItemDataBound(object sender, GridItemEventArgs e)
        {
        ...
        protected void uxMRFMaster_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            //    uxMRFMaster.MasterTableView.ClearEditItems();
            //    e.Canceled = true;
            ...
            //        uxMRFMaster.MasterTableView.ClearEditItems();
            //        uxMRFMaster.MasterTableView.IsItemInserted = false;
            //        uxMRFMaster.Rebind();
            //    }
            //}
        }
        ...
        //    uxMRFMaster.MasterTableView.FilterExpression = filterExpression;
        //    uxMRFMaster.MasterTableView.Rebind();
