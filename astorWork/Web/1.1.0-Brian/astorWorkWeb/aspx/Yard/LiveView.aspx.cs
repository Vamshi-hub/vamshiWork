    ...
    public partial class LiveView : System.Web.UI.Page
    {
        ...
        protected void RadMap_ItemDataBound(object sender, MapItemDataBoundEventArgs e)
        {
            ...
            if (marker != null)
            {
                ...
                sb.Append("<div class='rightCol'><div class='country'><span style='color:#2ccef5;font-size:12px;font-weight:bold;'>" + item.Row["LocationName"] + "</span></div><div class='city'>Material Count <img style='border:0;width:13px;height:13px;' src=\"../../Images/Page_Icon.png\" /><a onclick=\"addTab('Site View (Material)','../Yard/Pivot.aspx?type=1&YardID=" + YardID + "');\"><span style='color:LightBlue;font-size:15px;font-weight:bold;text-decoration: underline;cursor:pointer;'>" + item.Row["MaterialCount"] + "</span></a></div></div>");
