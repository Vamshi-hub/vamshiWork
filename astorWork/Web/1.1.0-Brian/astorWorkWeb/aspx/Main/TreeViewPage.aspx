                        ...
                        <Items>
                            <telerik:RadPanelItem Text="Configuration" ImageUrl="../../images/config.png" Expanded="True"
                                ...
                                <Items>
                                    ...
                                    <telerik:RadPanelItem ImageUrl="../../images/yardmaster.png" Text="Yard Master" onclick="addTab('Yard Master','../Configuration/AddViewYardMaster.aspx');" />
                            ...
                            <telerik:RadPanelItem Text="Material Management" ImageUrl="../../images/material_management.png">
                                <Items>
                                    <telerik:RadPanelItem ImageUrl="../../Images/Page_Icon.png" Text="Dashboard" onclick="addTab('Dashboard (Material Tracking)','../Reports/MaterialTracking/Dashboard.aspx');" />
                                    <telerik:RadPanelItem ImageUrl="../../images/liveview.png" Text="Live View" onclick="addTab('Live View','../Yard/LiveView.aspx');" />
                                    <telerik:RadPanelItem ImageUrl="../../images/siteview.png" Text="Site View" onclick="addTab('Site View','../Yard/Pivot.aspx?type=1');"/>
                            ...
                            <telerik:RadPanelItem Text="Time Attendance" ImageUrl="../../Images/Time_Management.png" ID="menuTimeAttendance">
                                <Items>
                            ...
                            <telerik:RadPanelItem Text="JobAllocation Reports" ImageUrl="../../Images/Project_Costing.png" ID="menuJobAllocation">
                                <Items>
                                    <telerik:RadPanelItem ImageUrl="../../Images/dashboard.png" Text="Dashboard" onclick="addTab('Dashboard (Job Allocation)','../Reports/JobAllocation/Dashboard.aspx');" />
                            ...
                            <telerik:RadPanelItem Text="BIM" ImageUrl="../../Images/yardmaster.png" ID="menuBIM">
                                <Items>
                                    <telerik:RadPanelItem ImageUrl="../../Images/config.png" Text="Plugin - Navisworks" onclick="addTab('Plugin for Navisworks','/astorWorkMVC/BIMUserInfoes/Plugin');" />
                                    <telerik:RadPanelItem ImageUrl="../../Images/Reload.png" Text="Sync Status" onclick="addTab('Sync Status','/astorWorkMVC/BIMSyncHists');" />
